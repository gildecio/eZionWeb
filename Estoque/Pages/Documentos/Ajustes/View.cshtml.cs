...
public class ViewModel : PageModel
{
    ...
    public AjusteEstoque? Doc { get; set; }
    ...
    {
        Doc = _docs.GetAjustes().FirstOrDefault(d => d.Id == id);
        ...
        {
            Itens = new List<DocumentoItem>
            {
                new DocumentoItem { ProdutoId = Doc.ProdutoId, UnidadeId = Doc.UnidadeId, Quantidade = Doc.Quantidade }
            };
        }
