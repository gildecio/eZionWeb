...
public class EditModel : PageModel
{
    ...
    {
        var item = _docs.GetTransferencias().FirstOrDefault(d => d.Id == id);
        ...
        LocalOrigemId = item.LocalOrigemId;
    ...
    public IActionResult OnPost()
    {
        ...
        try
        {
            var doc = new TransferenciaEstoque { Id = Id, ProdutoId = ProdutoId, LocalOrigemId = LocalOrigemId, LocalDestinoId = LocalDestinoId, UnidadeId = UnidadeId, Quantidade = Quantidade, Observacao = Observacao };
            _docs.UpdateTransferencia(doc);
            return RedirectToPage("Index");
        }
        catch (Exception ex)
        {
